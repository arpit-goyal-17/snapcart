    ...
    const slides=[
        {
            ...
            subtitle:"Farm fresh fruits, vegetables, and daily essentials ddelivered to you.",
            btnText:"Shop Now",
            bg:"https://plus.unsplash.com/premium_photo-1663012860167-220d9d9c8aca?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
            id:2,
            ...
            btnText:"Order Now",
            bg:"https://images.unsplash.com/photo-1683553170878-049f180627b0?q=80&w=1625&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
            id:3,
            icon:<Smartphone className='w-20 h-20 sm:w-28 sm:h-28 text-blue-400 drop-shadow-lg'/>,
            title:"Shop Anytime, Anywhere 📱",
            subtitle:"Easy and seamless online grocery shoping experience",
            btnText:"Get Started",
            bg:"https://plus.unsplash.com/premium_photo-1663089804061-a1939bccc4c7?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        }
    ]
    ...
    <div className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl'>
      <AnimatePresence mode='wait'>
        ...
        className='absolute inset-0'>
            <Image src={slides[current].bg} fill alt="slide" priority
      ...
      <div className='absolute inset-0 flex items-center justify-center text-center text-white px-6'>
        ...
        className='flex flex-col items-center justify-center gap-6 max-w-3xl'>
            ...
            <h1 className='text-3xl sm:text-5xl md:text-6xl font-semibold tracking-tight drop-shadow-lg'>{slides[current].title}</h1>
