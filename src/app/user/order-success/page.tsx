  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-linear-to-b from-green-50 to-white'>
      ...
      className='relative'>
        ...
        >
            <div className='w-full rounded-full h-full bg-green-700 blur-2xl'/>
        </motion.div>
      </motion.div>
      <motion.h1
      ...
      >Order Placed Successfully</motion.h1>
      <motion.p
      initial={{opacity:0,y:30}}
      animate={{opacity:1,y:0}}
      ...
      initial={{opacity:0,scale:0.9}}
        ...
        whileTap={{scale:0.93}}
        className='flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-base font-semibold px-8 py-3 rounded-full shadow-ld transition-all'>
      ...
      >
        ...
        <div className='absolute top-10 left-[50%] w-2 h-2 bg-green-400 rounded-full animate-bounce'/>
