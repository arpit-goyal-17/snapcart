...
function page() {
    ...
    to-white py-16 px-4 relative'>
            <Link href={"/"} className='absolute top-6 left-6 flex items-center gap-2 text-green-700 
      font-semibold bg-white px-4 py-2 rounded-full shadow-md hover:bg-green-100 hover:shadow-lg
      transition-all'>
                <ArrowLeft /> <span className='hidden md:flex'>
                    Back to Home
                </span>
            </Link>
            <motion.div
                ...
                <form className='flex flex-col gap-6 w-full' onSubmit={handleSubmit}>
                    <div>
                        ...
                        >Grocery Name <span className='text-red-500'>*</span></label>
            ...
            focus:ring-2 focus:ring-green-400 transition-all'
                    ...
                    bg-white '
                        ...
                        <div>
                            ...
                            <select name='unit' value={unit} className='w-full border border-gray-300
                    rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all
                    bg-white '
                    ...
                    <div>
                        <label htmlFor='price'
                            className='block text-gray-700 font-medium mb-1'
                        >Grocery Price <span className='text-red-500'>*</span></label>
                        <input type="text" id='price' placeholder='eg: 120'
                            className='w-full border border-gray-300 rounded-xl px-4 py-3 outline-none 
            focus:ring-2 focus:ring-green-400 transition-all'
                    ...
                    <div className='flex flex-col sm:flex-row items-center gap-5'>
                        <label htmlFor='image'
                            ...
                            bg-green-50 text-green-700 font-semibold border
                            border-green-200 rounded-xl px-6 py-3 hover:bg-green-100 transition-all
                            w-full sm:w-auto'
                        >
